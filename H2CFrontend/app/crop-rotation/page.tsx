...
import { AlertCircle, Download, Save, Trash2, Plus, RefreshCw, Info } from "lucide-react"
...
export default function CropRotation() {
  ...
  const cropCategories = {
    Legumes: [
      { name: "Beans", icon: "🌱", color: "bg-green-100", seasons: ["spring", "summer"] },
      { name: "Peas", icon: "🌱", color: "bg-green-100", seasons: ["spring", "autumn"] },
      { name: "Lentils", icon: "🌱", color: "bg-green-100", seasons: ["spring"] },
      { name: "Soybeans", icon: "🌱", color: "bg-green-100", seasons: ["summer"] },
    ],
    "Root Vegetables": [
      { name: "Potatoes", icon: "🥔", color: "bg-amber-100", seasons: ["spring", "summer"] },
      { name: "Carrots", icon: "🥕", color: "bg-amber-100", seasons: ["spring", "summer", "autumn"] },
      { name: "Beets", icon: "🫐", color: "bg-amber-100", seasons: ["spring", "summer", "autumn"] },
      { name: "Radishes", icon: "🫐", color: "bg-amber-100", seasons: ["spring", "autumn"] },
    ],
    "Leafy Greens": [
      { name: "Lettuce", icon: "🥬", color: "bg-emerald-100", seasons: ["spring", "autumn"] },
      { name: "Spinach", icon: "🥬", color: "bg-emerald-100", seasons: ["spring", "autumn"] },
      { name: "Kale", icon: "🥬", color: "bg-emerald-100", seasons: ["spring", "autumn", "winter"] },
      { name: "Cabbage", icon: "🥬", color: "bg-emerald-100", seasons: ["spring", "autumn"] },
    ],
    "Fruiting Vegetables": [
  ...
  const savePlan = () => {
    ...
    setSavedPlans([...savedPlans, planName])
  }
  ...
  const seasonHeaders = ["Spring", "Summer", "Fall", "Winter"]
            ...
            <Card className="lg:col-span-1">
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Select value={selectedSeason} onValueChange={setSelectedSeason}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="autumn">Fall</SelectItem>
                ...
                <div className="space-y-4 mt-4">
                  {getSeasonalCrops().map(({ category, crops }) => (
                    <div key={category}>
